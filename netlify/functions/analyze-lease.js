...
const COLUMN_MAPPINGS = {
  ...
  model: ['VARIANT', 'VEHICLE DESCRIPTION', 'MODEL', 'DESCRIPTION', 'VEHICLE', 'DERIVATIVE'],
  monthly_payment: [
    ...
    'RENTAL', 'RENTAL EX VAT', 'RENTAL EXC VAT', 'RENTAL EXCL VAT', '3 + RENTAL EX VAT', '3+RENTAL',
    'LEASE PAYMENT', 'MONTHLY COST'
  ],
  p11d: ['P11D', 'MSRP', 'LIST PRICE', 'RRP', 'PRICE', 'LIST'],
  otr_price: ['OTR PRICE', 'OTR', 'ON THE ROAD', 'TOTAL PRICE'],
  mpg: ['FUEL_ECO_COMBINED', 'FUEL ECO COMBINED', 'MPG', 'FUEL ECONOMY', 'MILES PER GALLON', 'MPG COMBINED'],
  co2: ['CO2_G_PER_KM', 'CO2 G PER KM', 'CO2', 'EMISSIONS', 'CO2 EMISSIONS', 'CARBON'],
  insurance_group: ['INSURANCE GROUP', 'INSURANCE', 'INS GRP'],
  cap_id: ['CAP_CODE', 'CAP CODE', 'CAP ID', 'CAP', 'CAPID'],
